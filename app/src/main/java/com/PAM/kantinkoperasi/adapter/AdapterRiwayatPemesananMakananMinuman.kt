...
class AdapterRiwayatPemesananMakananMinuman(var data: ArrayList<PemesananMakananMinuman>, var listener: Listeners) : RecyclerView.Adapter<AdapterRiwayatPemesananMakananMinuman.Holder>() {
...
//        holder.tvStatus.setTextColor(color)
    ...
    interface Listeners {
        fun onClicked(data: PemesananMakananMinuman)
    }
}