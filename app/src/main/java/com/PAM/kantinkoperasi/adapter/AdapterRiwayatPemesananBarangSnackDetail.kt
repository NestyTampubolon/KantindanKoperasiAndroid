...
class AdapterRiwayatPemesananBarangSnackDetail(var data: ArrayList<PemesananBarangSnackDetail>) : RecyclerView.Adapter<AdapterRiwayatPemesananBarangSnackDetail.Holder>() {
...
//            listener.onClicked(a)
        ...
        val image = Config.productUrl2 + p.gambar
        Picasso.get()
            .load(image)
